					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-right no-padding">
							<ul>
								...
								<li><a href=""><span class="lnr lnr-envelope"></span><span>Entrar</span></a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
							<a href="index.html">
								...
								<h3 class="title text-muted">UniversalFC</h3>
							</a>
						</div>
				...
				<div class="row align-items-center justify-content-between">
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<li><a href="archive.html">Resultados</a></li>
							<li><a href="category.html">Jogadores</a></li>
							<li><a href="category.html">Clubes</a></li>
							<li class="menu-has-children"><a href="">Competições</a>
							<ul>
								<li><a href="standard-post.html">America do Sul</a></li>
								<li><a href="image-post.html">Europa</a></li>
								<li><a href="gallery-post.html">Oceania</a></li>
					...
					<div class="navbar-right">
						<form class="Search">
							<input type="text" class="form-control Search-box" name="Search-box" id="Search-box" placeholder="Buscar">
					...
					<div class="row small-gutters">
						<div class="col-lg-8 top-post-left">
							<div class="feature-image-thumb relative">
								...
								<img class="img-fluid" src="https://cdn.meutimao.com.br/_upload/noticia/2018/07/21/cassio-falhou-no-terceiro-gol-do-sao-paulo-neste_ez.jpg" alt="">
							</div>
							<div class="top-post-details">
								...
								<a href="image-post.html">
									<h3>Corinthians joga mal e perde clássico no Morumbi</h3>
								</a>
								<ul class="meta">
									<li><a href="#"><span class="lnr lnr-user"></span>Marcações</a></li>
									<li><a href="#"><span class="lnr lnr-calendar-full"></span>06 de abril, 2018</a></li>
									<li><a href="#"><span class="lnr lnr-bubble"></span>06 comentários</a></li>
								</ul>
							</div>
						</div>
